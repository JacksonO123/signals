...
export declare const forceGuardTrack: (fn: () => void, value: boolean) => void;
...
export declare const memo: <T>(fn: () => T) => Accessor<T | null>;
...
export declare const getUntrackedValue: <T>(signal: Accessor<T>) => T;
